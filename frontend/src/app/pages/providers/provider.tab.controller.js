      ...
      function ProvidersTabController(Provider, localStorageService, $q, baConfig, baUtil){
        ...
        function getCharts(report){
          /* Sorry for this mess, but the xml response is a fucking mess.
            Mybe I could use something more cool like recursive, but is too late
          */
          ...
          vm.charts = [].concat([{
                ...
                stats: vm.platformSearches[vm.platformSearches.length-2]
                      .search_reg,
                icon: 'person',
            },
            {
                ...
                stats: vm.platformRequests[vm.platformSearches.length-2].record_view,
                icon: 'face',
            },
            {
                color: pieColor,
            ...
            },
            {
                ...
                stats:vm.platformRequests[vm.platformSearches.length-2].result_click,
                icon: 'face',
            }])

 ...
 * GET     /api/dashboard/:id          ->  show
 * PUT     /api/dashboard/:id          ->  upsert
 * PATCH   /api/dashboard/:id          ->  patch
 * DELETE  /api/dashboard/:id          ->  destroy
 */
...
export function create(req, res) {
  return Dashboard.create(req.body)
...
export function upsert(req, res) {
  ...
  return Dashboard.findOneAndUpdate({_id: req.params.id}, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()

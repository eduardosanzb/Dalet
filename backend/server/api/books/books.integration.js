...
describe('Books API:', function() {
  ...
  describe('PUT /api/books/:id', function() {
    ...
    it('should respond with the original books', function() {
      expect(updatedBooks.name).to.equal('New Books');
      expect(updatedBooks.info).to.equal('This is the brand new books!!!');
    });
